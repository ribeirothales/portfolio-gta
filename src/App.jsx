          ...
          <div className="w-full about-me h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex flex-col md:flex-row text-white w-full h-[90%] px-5 md:px-0">
              ...
              <div className="rg text-justify w-full xl:w-[32%] md:w-[45%] py-10 xl:py-20 md:py-30">
                ...
                <p className="mt-5 md:mt-10 text-justify text-base sm:text-4xl md:text-4xl lg:text-xl [@media(min-width:2560px)]:text-4xl [@media(min-width:3840px)]:text-[50px] font-[Helvetica_Now_Display]">
                ...
                <p className="mt-5 md:mt-6 text-justify text-base sm:text-4xl md:text-4xl lg:text-xl [@media(min-width:2560px)]:text-4xl [@media(min-width:3840px)]:text-[50px] font-[Helvetica_Now_Display]">
